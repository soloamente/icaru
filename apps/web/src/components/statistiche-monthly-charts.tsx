	...
	return (
		<>
			...
			<div className="flex w-full min-w-0 items-center gap-1.5">
				...
				<ul className="scroll-fade-x flex min-w-0 flex-1 touch-pan-x list-none gap-1 overflow-x-auto overflow-y-visible p-0 pt-4 pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
					{chartData.map((d) => {
