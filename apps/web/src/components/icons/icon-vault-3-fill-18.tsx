...
export interface IconVault3Fill18Props extends SVGProps<SVGSVGElement> {
	size?: number;
}

/** Vault icon for "Totale importo aperto" dashboard card background. */
export function IconVault3Fill18({
	size = 18,
	...props
}: IconVault3Fill18Props) {
	return (
		<svg
			aria-hidden="true"
			height={size}
