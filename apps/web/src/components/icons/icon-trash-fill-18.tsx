...
export interface IconTrashFill18Props extends SVGProps<SVGSVGElement> {
	size?: number;
}

/** Filled trash icon (18×18) used for destructive "Rimuovi" actions on attachments. */
export function IconTrashFill18({ size = 18, ...props }: IconTrashFill18Props) {
	return (
		<svg
			aria-hidden="true"
			height={size}
