...
export { IconArrowUpRightFill12 } from "./icon-arrow-up-right-fill-12";
...
export { IconCircleOpenArrowUpRight } from "./icon-circle-open-arrow-up-right";
...
export { IconDesignFileDownloadFill18 } from "./icon-design-file-download-fill-18";
...
export { IconFileDownloadFill18 } from "./icon-file-download-fill-18";
...
export { IconPenWritingFill18 } from "./icon-pen-writing-fill-18";
export { IconPeople } from "./icon-people";
export { IconPinFill18 } from "./icon-pin-fill-18";
