...
export default function TrattativeAbbandonateEditPage() {
	...
	const backHref = "/trattative/abbandonate";

	/**
	 * Dopo conferma, DELETE /api/negotiations/{id} e redirect alla lista
	 * trattative nello stesso segmento (qui: abbandonate).
	 */
	...
	// flusso di conferma: se il form è sporco apriamo il dialog con l'href richiesto,
	// altrimenti navighiamo subito.
	useEffect(() => {
	...
	return (
		<main className="m-1 flex flex-1 flex-col gap-2 overflow-hidden rounded-3xl bg-card px-3 pt-4 font-medium sm:m-2.5 sm:gap-2.5 sm:px-9 sm:pt-6">
			{/* Header: md+ azioni a destra; sotto md riga duplicata sotto al form (md:hidden). */}
			<div className="relative flex w-full flex-col gap-4.5">
